(() => {
    ...
    function initSliders() {
        if (document.querySelector(".top-main-block__slider")) {
            ...
            if (document.querySelector(".slider-product__content")) new core(".slider-product__content", {
            ...
            if (document.querySelector(".slider-product__bg")) new core(".slider-product__bg", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
