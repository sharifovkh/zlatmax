(() => {
    ...
    (() => {
        ...
        new core(".top-main-block__slider", {
        ...
        new core(".slider-product__content", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        const inputfrom = document.querySelector("#range-from");
        const inputTo = document.querySelector("#range-to");
        ...
        const rangeItem2 = document.querySelector("#range-item2");
        const inputfrom2 = document.querySelector("#range-from2");
        const inputTo2 = document.querySelector("#range-to2");
        const inputs2 = [ inputfrom2, inputTo2 ];
        ...
        const rangeItem3 = document.querySelector("#range-item3");
        const inputfrom3 = document.querySelector("#range-from3");
        const inputTo3 = document.querySelector("#range-to3");
        const inputs3 = [ inputfrom3, inputTo3 ];
